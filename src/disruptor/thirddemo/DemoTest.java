...
public class DemoTest {
	public static void main(String[] args) {
	     ...
	     Disruptor<TradeTransaction> disruptor=new Disruptor<TradeTransaction>(new TradeTransactionFactory(),
	     ...
	     System.out.println("总耗时:"+(System.currentTimeMillis()-beginTime.getTime()));  
	}
}
